...
<div class="modal-body">
    ...
    <input type="text" id="new_supplier" class="form-control" list="supplier_options" placeholder="เลือกหรือพิมพ์ใหม่...">
        ...
        <div class="row">
            ...
            <div class="col mb-3">
                ...
                <input type="text" id="new_unit" class="form-control" list="unit_options" placeholder="เลือกหรือพิมพ์ใหม่">
...
<div class="modal fade" id="editModal" tabindex="-1">
    ...
    <input type="text" id="edit_type" class="form-control" list="type_options" placeholder="เลือกหรือพิมพ์ใหม่">
</div>
<div class="col">
    <label>Supplier</label><input type="text" id="edit_supplier" class="form-control" list="supplier_options" placeholder="เลือกหรือพิมพ์ใหม่">
</div>
                <div class="row">
                <div class="col"><label>ราคาซื้อ</label><input type="number" id="edit_price" class="form-control"></div>
                <div class="col"><label>หน่วยนับ</label><input type="text" id="edit_unit" class="form-control" list="unit_options" placeholder="เลือกหรือพิมพ์ใหม่">
            </div>
            <div class="modal-footer">
